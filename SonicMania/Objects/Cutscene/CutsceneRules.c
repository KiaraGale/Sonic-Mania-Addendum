...
{
    if ((RSDK.CheckSceneFolder("GHZ") && !Zone->actID) || (RSDK.CheckSceneFolder("GHZE") && !Zone->actID) || ((RSDK.CheckSceneFolder("CPZ") || RSDK.CheckSceneFolder("CPZE")) && !Zone->actID) || RSDK.CheckSceneFolder("SPZ1")
