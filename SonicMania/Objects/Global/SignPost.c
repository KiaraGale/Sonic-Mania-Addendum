                    ...
                    if (globals->gameMode == MODE_COMPETITION) {
                        ...
                        if (!self->activePlayers) {
                            switch (player->characterID) {
                                ...
                                case ID_RAY:
                                    RSDK.SetSpriteAnimation(SignPost->aniFrames, SIGNPOSTANI_RAY, &self->facePlateAnimator, true, 0);
                                    break;

                                case ID_AMY:
                                    RSDK.SetSpriteAnimation(SignPost->aniFrames, SIGNPOSTANI_AMY, &self->facePlateAnimator, true, 0);
                                    break;
#endif
                            }
