...
struct ObjectPlayer {
    ...
    TABLE(color superPalette_Knux[18], { 0x580818, 0x980130, 0xD00840, 0xE82858, 0xF06080, 0xF08088, 0x580818, 0x980130, 0xD00840, 0xE82858, 0xF06080,
                                         0xF08088, 0xF05878, 0xF06090, 0xF080A0, 0xF098B0, 0xF0B0C8, 0xF0C0C8 });
    ...
    TABLE(color miraclePalette_Amy[18], { 0x64036E, 0x980F8C, 0xC02AAA, 0xEA51B5, 0xF678D0, 0xFABBE3, 0x39C063, 0x28D77E, 0x5DE99D, 0x8CF2BB, 0xAFF8D2,
                                          0xD3FDE2, 0x51ACDB, 0x5DC5E9, 0x75DAF0, 0x8EEAF5, 0xA8F6FA, 0xCAFCFC });
    ...
    TABLE(int32 miracleColors[28],
        { 0x2C0656, 0xFCA6DA, 0xFEC8EB, 0xFEE1F5, 0x623259, 0x8A407D, 0xC67595, 0xE5A9B4, 0xFDD6D7, 0xFFF0F0, 0x490198, 0x8A01D0, 0xC53AE9, 0xEC9FEF,
          0x58CA9F, 0x76DBB6, 0x91EDCE, 0xBEF4E2, 0x8D4311, 0xC15A15, 0xE27F22, 0xEAA939, 0xEED253, 0xEBE67A, 0x6A21B5, 0x8735ED, 0x9066F4, 0x9E93F0 });
    int32 colorStorage[28];
    TABLE(int32 miracleColors_HCZ[28],
        { 0x5B77A0, 0xC2C7E2, 0xC3D8EB, 0xC3E5EF, 0x768DA2, 0x8A94B4, 0xA7AFC0, 0xB7C9CF, 0xC3DFE1, 0xC4ECED, 0x6975C1, 0x8A75DD, 0xA791EA, 0xB8BBEB,
          0x71D9C5, 0x80E2D0, 0x8DEADC, 0xA3EEE6, 0x8B967E, 0xA5A180, 0xB5B486, 0xB9C992, 0xBBDD9F, 0xBAE7B2, 0x7A85D0, 0x888FEB, 0x8DA8EF, 0x93BEED });
    int32 colorStorage_HCZ[28];
    TABLE(int32 miracleColors_CPZ[28],
        { 0x914BA9, 0xF89AEB, 0xF9ABF3, 0xF9B8F8, 0xAC61AA, 0xC068BC, 0xDE82C8, 0xED9CD8, 0xF9B2E9, 0xFABFF6, 0x9F48CA, 0xC048E6, 0xDD65F2, 0xEF8FF4,
          0xA7ACCD, 0xB6B5D9, 0xC3BEE5, 0xDAC1EF, 0xC16986, 0xDB7588, 0xEC878F, 0xF09C9A, 0xF2B0A7, 0xF0BABB, 0xB058D8, 0xBE62F4, 0xC37BF8, 0xCA91F6 });
    int32 colorStorage_CPZ[28];
};
#else
struct ObjectPlayer {
    RSDK_OBJECT
