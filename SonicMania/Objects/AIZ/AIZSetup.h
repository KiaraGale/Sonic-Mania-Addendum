...
typedef enum {
    CUTSCENE_KNUX_FIGHT,
    CUTSCENE_KNUX_RELAX,
    CUTSCENE_KNUX_SURPRISE,
    CUTSCENE_KNUX_STANDUP,
    CUTSCENE_KNUX_HURT,
    CUTSCENE_KNUX_IMPACT,
    CUTSCENE_KNUX_PLANE,
    CUTSCENE_KNUX_SHAKEHEAD,
    CUTSCENE_SONIC_RELAX,
    CUTSCENE_SONIC_SURPRISE,
    CUTSCENE_SONIC_STANDUP,
    CUTSCENE_SONIC_FIGHT,
    CUTSCENE_SONIC_HURT,
    CUTSCENE_TAILS_RELAX,
    CUTSCENE_TAILS_SURPRISE,
    CUTSCENE_TAILS_STANDUP,
    CUTSCENE_TAILS_FIGHT,
    CUTSCENE_TAILS_HURT,
    CUTSCENE_MIGHTY_RELAX,
    CUTSCENE_MIGHTY_SURPRISE,
    CUTSCENE_MIGHTY_STANDUP,
    CUTSCENE_MIGHTY_FIGHT,
    CUTSCENE_MIGHTY_HURT,
    CUTSCENE_RAY_RELAX,
    CUTSCENE_RAY_SURPRISE,
    CUTSCENE_RAY_STANDUP,
    CUTSCENE_RAY_FIGHT,
    CUTSCENE_RAY_HURT,
    CUTSCENE_AMY_RELAX,
    CUTSCENE_AMY_SURPRISE,
    CUTSCENE_AMY_STANDUP,
    CUTSCENE_AMY_FIGHT,
    CUTSCENE_AMY_HURT,
} KnuxCutsceneAnims;
