...
static LeaderboardID leaderboardInfo[] = {
    ...
    { .idPS4 = 253, .idUnknown = 250, .idSwitch = 310, .idXbox = "PlusHCZ2AmyMania",        .idPC = "HCZ2_A_MANIA" },
    { .idPS4 = -1,  .idUnknown = -1,  .idSwitch = -1,  .idXbox = NULL,                      .idPC = NULL },
    { .idPS4 = 255, .idUnknown = 251, .idSwitch = 311, .idXbox = "PlusMSZ2AmyMania",        .idPC = "MSZ2_A_MANIA" },
    { .idPS4 = 256, .idUnknown = 252, .idSwitch = 312, .idXbox = "PlusOOZ1AmyMania",        .idPC = "OOZ1_A_MANIA" },
    { .idPS4 = 257, .idUnknown = 253, .idSwitch = 313, .idXbox = "PlusOOZ2AmyMania",        .idPC = "OOZ2_A_MANIA" },
    { .idPS4 = 258, .idUnknown = 254, .idSwitch = 314, .idXbox = "PlusLRZ1AmyMania",        .idPC = "LRZ1_A_MANIA" },
    { .idPS4 = 259, .idUnknown = 255, .idSwitch = 315, .idXbox = "PlusLRZ2AmyMania",        .idPC = "LRZ2_A_MANIA" },
    { .idPS4 = 260, .idUnknown = 256, .idSwitch = 316, .idXbox = "PlusMMZ1AmyMania",        .idPC = "MMZ1_A_MANIA" },
    { .idPS4 = 261, .idUnknown = 257, .idSwitch = 317, .idXbox = "PlusMMZ2AmyMania",        .idPC = "MMZ2_A_MANIA" },
    { .idPS4 = 262, .idUnknown = 258, .idSwitch = 318, .idXbox = "PlusTMZ1AmyMania",        .idPC = "TMZ1_A_MANIA" },
    { .idPS4 = 263, .idUnknown = 259, .idSwitch = 319, .idXbox = "PlusTMZ2AmyMania",        .idPC = "TMZ2_A_MANIA" },

    { .idPS4 = 264, .idUnknown = 260, .idSwitch = 320, .idXbox = "PlusGHZ1AmyEncore",       .idPC = "GHZ1_A_ENCORE" },
    { .idPS4 = 265, .idUnknown = 261, .idSwitch = 321, .idXbox = "PlusGHZ2AmyEncore",       .idPC = "GHZ2_A_ENCORE" },
    { .idPS4 = 266, .idUnknown = 262, .idSwitch = 322, .idXbox = "PlusCPZ1AmyEncore",       .idPC = "CPZ1_A_ENCORE" },
    { .idPS4 = 267, .idUnknown = 263, .idSwitch = 323, .idXbox = "PlusCPZ2AmyEncore",       .idPC = "CPZ2_A_ENCORE" },
    { .idPS4 = 268, .idUnknown = 264, .idSwitch = 324, .idXbox = "PlusSPZ1AmyEncore",       .idPC = "SPZ1_A_ENCORE" },
    { .idPS4 = 269, .idUnknown = 265, .idSwitch = 325, .idXbox = "PlusSPZ2AmyEncore",       .idPC = "SPZ2_A_ENCORE" },
    { .idPS4 = 270, .idUnknown = 266, .idSwitch = 326, .idXbox = "PlusFBZ1AmyEncore",       .idPC = "FBZ1_A_ENCORE" },
    { .idPS4 = 271, .idUnknown = 267, .idSwitch = 327, .idXbox = "PlusFBZ2AmyEncore",       .idPC = "FBZ2_A_ENCORE" },
    { .idPS4 = 272, .idUnknown = 268, .idSwitch = 328, .idXbox = "PlusPGZ1AmyEncore",       .idPC = "PGZ1_A_ENCORE" },
    { .idPS4 = 273, .idUnknown = 269, .idSwitch = 329, .idXbox = "PlusPGZ2AmyEncore",       .idPC = "PGZ2_A_ENCORE" },
    { .idPS4 = 274, .idUnknown = 270, .idSwitch = 330, .idXbox = "PlusSSZ1AmyEncore",       .idPC = "SSZ1_A_ENCORE" },
    { .idPS4 = 275, .idUnknown = 271, .idSwitch = 331, .idXbox = "PlusSSZ2AmyEncore",       .idPC = "SSZ2_A_ENCORE" },
    { .idPS4 = 276, .idUnknown = 272, .idSwitch = 332, .idXbox = "PlusHCZ1AmyEncore",       .idPC = "HCZ1_A_ENCORE" },
    { .idPS4 = 277, .idUnknown = 273, .idSwitch = 333, .idXbox = "PlusHCZ2AmyEncore",       .idPC = "HCZ2_A_ENCORE" },
    { .idPS4 = 278, .idUnknown = 274, .idSwitch = 334, .idXbox = "PlusMSZ1AmyEncore",       .idPC = "MSZ1_A_ENCORE" },
    { .idPS4 = 279, .idUnknown = 275, .idSwitch = 335, .idXbox = "PlusMSZ2AmyEncore",       .idPC = "MSZ2_A_ENCORE" },
    { .idPS4 = 280, .idUnknown = 276, .idSwitch = 336, .idXbox = "PlusOOZ1AmyEncore",       .idPC = "OOZ1_A_ENCORE" },
    { .idPS4 = 281, .idUnknown = 277, .idSwitch = 337, .idXbox = "PlusOOZ2AmyEncore",       .idPC = "OOZ2_A_ENCORE" },
    { .idPS4 = 282, .idUnknown = 278, .idSwitch = 338, .idXbox = "PlusLRZ1AmyEncore",       .idPC = "LRZ1_A_ENCORE" },
    { .idPS4 = 283, .idUnknown = 279, .idSwitch = 339, .idXbox = "PlusLRZ2AmyEncore",       .idPC = "LRZ2_A_ENCORE" },
    { .idPS4 = 284, .idUnknown = 280, .idSwitch = 340, .idXbox = "PlusMMZ1AmyEncore",       .idPC = "MMZ1_A_ENCORE" },
    { .idPS4 = 285, .idUnknown = 281, .idSwitch = 341, .idXbox = "PlusMMZ2AmyEncore",       .idPC = "MMZ2_A_ENCORE" },
    { .idPS4 = 286, .idUnknown = 282, .idSwitch = 342, .idXbox = "PlusTMZ1AmyEncore",       .idPC = "TMZ1_A_ENCORE" },
    { .idPS4 = 287, .idUnknown = 283, .idSwitch = 343, .idXbox = "PlusTMZ2AmyEncore",       .idPC = "TMZ2_A_ENCORE" },
};
// clang-format on
#endif
