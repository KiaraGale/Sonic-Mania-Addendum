...
struct EntityHPZIntro {
	...
	Animator animatorEmeraldGlow[7];
	EntityHPZBeam* teleBeam;
};
...
// States
void HPZIntro_State_TeleportPlayer(void);
void HPZIntro_State_RaiseEmeralds(void);
void HPZIntro_State_EmeraldsFlyOff(void);
void HPZIntro_State_ActivateSuperEmeralds(void);
