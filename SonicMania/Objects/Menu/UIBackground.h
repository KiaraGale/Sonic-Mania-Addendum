...
struct ObjectUIBackground {
    RSDK_OBJECT
#if MANIA_USE_PLUS
    TABLE(color bgColors[24], { 0xF0C800, 0xF08C18, 0x80A0B0, 0x50D8A0, 0xF09018, 0x38B0C8, 0x38B0C8, 0xF07028, 0x50D8A0, 0xC83868, 0x50D8A0, 0xF09018,
                                0xC0C098, 0x38B0C8, 0x88A0B8, 0xA850F0, 0x88C801, 0x1B0F0,  0x50B098, 0x890C8,  0xE8B010, 0xC83868, 0xA850F0, 0xF678D2 });
#else
